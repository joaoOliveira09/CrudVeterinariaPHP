<!doctype html>
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="cadastro.php">Cadastrar na veterinaria</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="visualizarCadastro.php">Visualizar</a>
            </li>
    ...
    <div class="container">
      <form>
        <h1>Visualizar e Pesquisar</h1>
        <div class="mb-3">
          <label for="pesquisa" class="form-label">Pesquisa:</label>
          <input type="text" class="form-control" id="pesquisa" name="pesquisa" 
          placeholder="Digite o nome de um Tutor ou cpf para pesquisar">
        </div>
              ...
              while($resultadoSeparado=mysqli_fetch_assoc($resultado)){
                echo "
                    <tr>
                      ...
                      <td><a class='btn btn-info' href='editarCadastro.php?codigo=$resultadoSeparado[codigo]'>Editar</a></td>
